 ...
 */
public class TestTwoColorsCircleView extends BaseCircleView {
    ...
    public TestTwoColorsCircleView(Context context) {
        this(context, null, R.styleable.CircleViewStyle_circleViewDefault);
    }

    public TestTwoColorsCircleView(Context context, AttributeSet attrs) {
        this(context, attrs, R.styleable.CircleViewStyle_circleViewDefault);
    }

    public TestTwoColorsCircleView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TestTwoColorsCircleView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(getWidth() / 2, getHeight() / 2, getWidth() / 2 - getSelectBorderWidth(), mPaint);
